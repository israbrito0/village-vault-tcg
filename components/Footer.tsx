  ...
  return (
    <footer className="mt-10 text-[11px] text-muted">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:grid-cols-3">
        ...
        <div>
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.18em] text-ink">
            Atendimento
          </p>
          <p className="leading-relaxed">
        ...
        <div>
          ...
          <ul className="space-y-1.5">
            <li>
              <Link href="/loja" className="transition-colors hover:text-brand-blue">
                Nossa loja
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/trocas" className="transition-colors hover:text-brand-blue">
                Trocas e devoluções
              </Link>
            </li>
          </ul>
